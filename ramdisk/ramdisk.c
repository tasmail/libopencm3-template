...
#define FILEDATA_SECTOR_COUNT	96
...
usbd_mass_storage *ramdisk_init(usbd_device *usb_device)
{
	uint32_t i = 0;

	usbd_mass_storage *res = usb_msc_init(usb_device, 0x82, 64, 0x01, 64, "VendorID", "ProductID",
